...
// // ─────────────────────────────────────────────────────────────
// // TEMPLATE  — new badge design (Iwillvote-3)
// // Upload this image to Cloudinary and paste the URL below
// // ─────────────────────────────────────────────────────────────
// // const TEMPLATE_URL = "https://res.cloudinary.com/dcdychfzw/image/upload/IWillVote2027_badge_v2.png"
// const TEMPLATE_URL = "/img/qw.jpg"
// const CANVAS_SIZE = 1000

// // ─────────────────────────────────────────────────────────────
// // LAYOUT — all coordinates are for a 1000×1000 canvas
// // ─────────────────────────────────────────────────────────────
// const LAYOUT = {
//     // Name — large bold green text, left side below the printed "I,"
//     name: {
//         x: 55,
//         y: 395,    // first baseline
//         maxWidth: 520,
//         fontSize: 52,
//         lineHeight: 62,
...
//     // State pill — dark green rounded rect, top right
//     statePill: { x: 615, y: 143, w: 330, h: 46, radius: 23 },
//     stateText: {
//         cx: 780,   // horizontal center of pill
//         cy: 170,    // vertical center (baseline adjusted)
//         font: "bold 18px 'Open Sans', sans-serif",
//         color: "#ffffff",
//     },

//     // Stars — inside the dark green footer bar, right side
//     // Smaller than before: 35px, gap 40px
//     stars: {
//         cx: 780,
//         y: 933,
//         size: 35,
...
//         template.onerror = () => {
//             // Fallback: white background so badge is still usable
...
//             await navigator.share({
//                 title: "I Will Vote in 2027",
//                 text: "I just pledged to vote in the 2027 Nigerian elections! #IWillVoteIn2027",
//                 files: [file],
//             }).catch(() => { })
//         }
//     }
...
// function drawOverlay(ctx: CanvasRenderingContext2D, data: PledgeFormData) {
//     const { name, statePill, stateText, stars } = LAYOUT

//     /* 1 — NAME: large bold green, left side below "I," */
//     ctx.font = name.font
//     ctx.fillStyle = name.color
//     ctx.textAlign = "left"
//     ctx.textBaseline = "alphabetic"
...
//     const maxLines = Math.floor(500 / name.lineHeight)
//     lines.slice(0, maxLines).forEach((line, i) => {
//         ctx.fillText(line, name.x, name.y + i * name.lineHeight)
//     })

//     /* 2 — STATE PILL: dark green rounded rect + centered white text */
//     const { x: px, y: py, w: pw, h: ph, radius: pr } = statePill
...
//     ctx.quadraticCurveTo(px, py, px + pr, py)
//     ctx.closePath()
//     ctx.fillStyle = "#15803d"   // green-700 — matches template
//     ctx.fill()
...
//     /* 3 — STARS: inside the dark green footer bar, right side */
//     const { cx: scx, y: sy, size: sSize, gap } = stars
//     const total = 6
//     const startX = scx - ((total - 1) * gap) / 2
...
//             sy,
//             sSize,
//             i < data.starCount ? "#fbbf24" : "rgba(255,255,255,0.2)",
//         )
//     }
